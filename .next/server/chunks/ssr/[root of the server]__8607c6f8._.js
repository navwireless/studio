...
function getRoadRouteEncodedPolyline(segments) {
    if (!segments) return "";
        ...
        if (link.losPossible) {
          ...
          <Placemark>
            ...
            <LineString><tessellate>1</tessellate><coordinates>${snappedPointA.lng},${snappedPointA.lat},0 ${snappedPointB.lng},${snappedPointB.lat},0</coordinates></LineString>
                ...
                } else if (link.fiberPathErrorMessage) {
                    extendedDataContent += `
...
function BulkLosAnalyzerPage() {
    ...
    const [calculateFiberPathBulkEnabled, setCalculateFiberPathBulkEnabled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
        if ("TURBOPACK compile-time falsy", 0) {
            "TURBOPACK unreachable";
        }
        return false;
    });
    const [fiberRadiusMetersBulk, setFiberRadiusMetersBulk] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
        if ("TURBOPACK compile-time falsy", 0) {
            "TURBOPACK unreachable";
        }
        return 500;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8607c6f8._.js.map