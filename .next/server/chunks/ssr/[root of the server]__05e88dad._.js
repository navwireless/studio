...
;
;
async function generateReportDocx(analysisResult, formData) {
    ...
    const tableData = [
        ...
        [
            "Latitude",
            pointA.lat.toFixed(6),
            pointB.lat.toFixed(6)
        ],
        [
            "Longitude",
            pointA.lng.toFixed(6),
            pointB.lng.toFixed(6)
        ],
        [
            "Tower Height (m)",
            pointA.towerHeight.toString(),
            pointB.towerHeight.toString()
        ],
        [
            "Aerial Distance (km/m)",
            distanceKm < 1 ? `${(distanceKm * 1000).toFixed(0)}m` : `${distanceKm.toFixed(1)}km`,
            ""
        ],
        [
            "Fresnel Height Considered (m)",
            clearanceThresholdUsed.toString(),
            ""
        ],
        [
            "Min. Actual Clearance (m)",
            minClearance?.toFixed(1) ?? 'N/A',
            ""
        ],
        [
            "LOS Feasible?",
    ...
    const tableRows = tableData.map((rowData, rowIndex)=>{
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableRow"]({
            children: rowData.map((cellData, cellIndex)=>{
                return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TableCell"]({
                    children: [
    ...
    const table = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Table"]({
        rows: tableRows,
        width: {
            size: 100,
        ...
        sections: [
            {
                ...
                children: [
                    ...
                    new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Paragraph"]({
                        children: [
                            new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TextRun"](remarksText)
                        ],
                    ...
                    new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Paragraph"]({
                        text: "Map snapshot showing link path.",
                        alignment: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AlignmentType"].CENTER,
                        style: "Caption"
                    }),
                    new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Paragraph"]({
    ...
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$file$2d$saver$2f$dist$2f$FileSaver$2e$min$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveAs"])(blob, `LOS_Report_${pointAName}_to_${pointBName}.docx`);
    } catch (error) {
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const isPointDataSufficientForStalenessCheck = (p)=>isValidNumeric(p.lat) && isValidNumeric(p.lng) && typeof p.height === 'number';
    ...
    const handleGenerateReport = async ()=>{
        if (analysisResult && !isStale) {
            ...
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$generator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateReportDocx"])(analysisResult, formData);
                toast({
            ...
            toast({
                ...
                description: "Please complete or re-analyze the link first.",
                variant: "destructive"
            });
        }
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__05e88dad._.js.map