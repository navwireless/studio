...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$polyline$2d$decoder$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/polyline-decoder.ts [app-ssr] (ecmascript)"); // For finding midpoint of fiber path
"use client";
;
;
;
...
function InteractiveMapInner({ pointA: formPointA, pointB: formPointB, onMapClick, onMarkerDrag, analysisResult, isStale, currentDistanceKm, fiberPathResult }) {
    ...
    if (fiberPathResult?.status === 'success' && fiberPathResult.segments && fiberPathResult.segments.length > 0) {
        ...
        if (targetSegmentPolyline) {
            const decoded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$polyline$2d$decoder$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["decodePolyline"])(targetSegmentPolyline);
            if (decoded.length > 0) {
