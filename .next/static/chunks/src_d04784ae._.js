(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_d04784ae._.js", {
...
async function generateReportDocx(analysisResult, formData) {
    ...
    const tableRows = tableData.map((rowData, rowIndex)=>{
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"]({
            children: rowData.map((cellData, cellIndex)=>{
                return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"]({
                    children: [
    ...
    const table = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Table"]({
        rows: tableRows,
        width: {
            size: 100,
        ...
        sections: [
            {
                ...
                children: [
                    ...
                    new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Paragraph"]({
                        children: [
                            new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$build$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TextRun"](remarksText)
                        ],
    ...
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$file$2d$saver$2f$dist$2f$FileSaver$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveAs"])(blob, `LOS_Report_${pointAName}_to_${pointBName}.docx`);
    } catch (error) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            const isPointDataSufficientForStalenessCheck = {
                "Home.useEffect.isPointDataSufficientForStalenessCheck": (p)=>isValidNumeric(p.lat) && isValidNumeric(p.lng) && typeof p.height === 'number'
    ...
    const handleGenerateReport = async ()=>{
        if (analysisResult && !isStale) {
            ...
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$report$2d$generator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateReportDocx"])(analysisResult, formData);
                toast({
...
//# sourceMappingURL=src_d04784ae._.js.map