(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_b380c222._.js", {
...
const BulkAnalysisMap = ({ placemarks, results })=>{
    ...
    const handleMapLoad = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BulkAnalysisMap.useCallback[handleMapLoad]": (map)=>{
            mapRef.current = map;
    ...
    }["BulkAnalysisMap.useCallback[handleMapLoad]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BulkAnalysisMap.useEffect": ()=>{
            if (isMapInstanceLoaded && mapRef.current && placemarks.length > 0) {
                const bounds = new window.google.maps.LatLngBounds();
                placemarks.forEach({
                    "BulkAnalysisMap.useEffect": (p)=>bounds.extend(new window.google.maps.LatLng(p.lat, p.lng))
                }["BulkAnalysisMap.useEffect"]);
                if (!bounds.isEmpty()) {
                    ...
                    const listener = window.google.maps.event.addListenerOnce(mapRef.current, 'idle', {
                        "BulkAnalysisMap.useEffect.listener": ()=>{
...
_s(BulkAnalysisMap, "Sp16igvueklpYUYXFSI2Ko0VBVY=");
_c = BulkAnalysisMap;
const __TURBOPACK__default__export__ = BulkAnalysisMap;
var _c;
__turbopack_context__.k.register(_c, "BulkAnalysisMap");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_b380c222._.js.map