(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_108193b6._.js", {
...
const OBSTRUCTION_DOT_COLOR = '#ef4444'; // Red-500
const TOWER_LINE_COLOR = '#eab308'; // Amber-500
...
const HORIZONTAL_PADDING_PERCENTAGE = 0.05; // 5% padding on each side
...
function CustomProfileChart({ data, pointAName = "Site A", pointBName = "Site B", isStale, totalDistanceKm, isActionPending, onTowerHeightChangeFromGraph }) {
        ...
        "CustomProfileChart.useCallback[drawChart]": ()=>{
            ...
            const getKmFromX = {
                "CustomProfileChart.useCallback[drawChart].getKmFromX": (pixelX_ChartArea_relative_to_padding_left)=>{
                    ...
                    // Allow slightly out of bounds for interpolation near edges
                    // if (effectivePx < -1 || effectivePx > effectiveChartWidthPx + 1) return -1; 
            ...
            for(let i = 0; i <= numXTicks; i++){
                ...
                const xPx = getX(distKm); // Use getX which includes padding
                ctx.beginPath();
                ctx.moveTo(xPx, 0);
            ...
            // Iterate across the effective chart width for obstruction check
            if (data.length > 1 && maxXKmActual > 0) {
                for(let px = 0; px <= effectiveChartWidthPx; px++){
                    const currentX_on_effective_width = px;
                    const currentX_on_chart_area = xOffsetPx + currentX_on_effective_width;
                    const currentKm = currentX_on_effective_width / effectiveChartWidthPx * maxXKmActual;
                    // LOS Y at currentX_on_chart_area
                    const losSlope = (yLosB_px_ChartArea - yLosA_px_ChartArea) / (xB_px_ChartArea - xA_px_ChartArea || 1); // Avoid div by zero
                    const los_y_at_currentX = yLosA_px_ChartArea + losSlope * (currentX_on_chart_area - xA_px_ChartArea);
                    // Terrain Y at currentKm
        ...
        "CustomProfileChart.useEffect": ()=>{
            ...
            const handleMouseMoveForTooltip = {
                "CustomProfileChart.useEffect.handleMouseMoveForTooltip": (event)=>{
                    ...
                    const { canvasRect, padding, getPixelXFromKm, getPixelYFromElevation, getKmFromPixelX, chartPixelWidth, xOffsetPx, effectivePixelWidth } = chartMetricsRef.current;
                    ...
                    // Check if mouse is within the data-displaying part of the chart
                    if (mouseXInChartArea >= xOffsetPx && mouseXInChartArea <= xOffsetPx + effectivePixelWidth) {
                        ...
                        // Find the closest actual data point for tooltip context
                        // This loop could be optimized, but for typical data sizes it's fine.
        ...
        "CustomProfileChart.useEffect": ()=>{
            ...
            const handleGlobalMouseMove = {
                "CustomProfileChart.useEffect.handleGlobalMouseMove": (event)=>{
                    ...
                    let newTowerLosY_px_ChartArea = dragStartInfo.initialLosY_px_ChartArea - clientYDelta; // Y is inverted from mouse
            ...
            const handleGlobalMouseUp = {
                "CustomProfileChart.useEffect.handleGlobalMouseUp": (event)=>{
                    ...
                    const { getElevationFromPixelY, chartPixelHeight } = chartMetricsRef.current; // Re-access for safety
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("w-full h-full relative", isStale && !isInteractingByDrag && "opacity-50", isActionPending && "pointer-events-none"),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)"); // Import React for key prop
;
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: isStale ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: "px-2 py-1 rounded-md text-xs font-semibold bg-yellow-500/80 text-yellow-100 flex items-center shadow",
                            children: [
                            ...
                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("px-3 py-1.5 rounded-md text-xs font-bold shadow-md", isClearBasedOnAnalysis ? "bg-los-success text-los-success-foreground" // Using theme colors
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("font-bold text-xs md:text-sm", isStale ? "text-slate-400" : actualMinClearance !== null && actualMinClearance >= (minRequiredClearance || 0) ? "text-los-success" : "text-los-failure"),
...
function BottomPanel({ analysisResult, isPanelGloballyVisible, onToggleGlobalVisibility, isContentExpanded, onToggleContentExpansion, isStale, control, register, handleSubmit, processSubmit, clientFormErrors, serverFormErrors, isActionPending, getValues, setValue, onTowerHeightChangeFromGraph }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("w-full overflow-hidden transition-[height] duration-500 ease-in-out", isContentExpanded ? "h-[45vh]" : "h-0" // Min height when collapsed to show handle
                ),
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_108193b6._.js.map