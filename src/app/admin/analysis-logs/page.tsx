...
export default function AnalysisLogsPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8 space-y-6">
            {/* Header */}
            <div>
                <h1 className="text-xl font-bold text-text-brand-primary">Analysis Logs</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex gap-2">
                    <Select value={typeFilter} onValueChange={(v) => { setTypeFilter(v); setPage(1); }}>
                        <SelectTrigger className="w-[140px] h-9 text-xs bg-surface-elevated border-surface-border-light text-text-brand-primary">
                    ...
                    <Select value={resultFilter} onValueChange={(v) => { setResultFilter(v); setPage(1); }}>
                        <SelectTrigger className="w-[120px] h-9 text-xs bg-surface-elevated border-surface-border-light text-text-brand-primary">
            ...
            <Card className="bg-surface-card border-surface-border">
                <CardHeader className="pb-0">
                    <CardTitle className="text-sm font-semibold text-text-brand-primary">Analyses</CardTitle>
                </CardHeader>
                <CardContent className="pt-4">
                    {isLoading ? (
                        <div className="text-center py-12">
                            <div className="h-6 w-6 border-2 border-brand-500/30 border-t-brand-500 rounded-full animate-spin mx-auto" />
                            <p className="text-sm text-text-brand-disabled mt-3">Loading analyses...</p>
                        </div>
                    ) : items.length === 0 ? (
                        <div className="text-center py-12">
                                        ...
                                        <TableRow key={item.id} className="border-surface-border hover:bg-surface-elevated/50">
                                            ...
                                            <TableCell>
                                                <div className="flex items-center gap-1.5">
                                                    ...
                                                    <span className="text-xs text-text-brand-secondary">
