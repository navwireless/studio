...
export default function PrivacyPage() {
    return (
        <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 overflow-auto">
            <AppHeader />

            <main className="flex-1 w-full max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
                <article className="prose prose-invert prose-sm sm:prose-base max-w-none prose-headings:text-white prose-p:text-white/70 prose-li:text-white/70 prose-strong:text-white/90 prose-a:text-teal-400 hover:prose-a:text-teal-300">
                    <h1 className="text-3xl sm:text-4xl font-bold tracking-tight !mb-2">
                        Privacy Policy
                    </h1>
                    <p className="text-sm !text-white/30 !mt-0 !mb-8">
